                ...
                <div class="card-body">
                    {{ Form::open([
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <img src="{{ $product_data['cover_url'] }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                {{ Form::text('category_name', $product_data['category_name'], [
                                    'class' => 'form-control',
                                    'disabled'
                                ]) }}
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <a href="{{ $product_data['sample_url'] }}" download>{{ __('Download') }}</a>
                            </div>
                        </div>
                        <div class="form-group row">
                            {{ Form::label('', __('File'), [
